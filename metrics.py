...
def get_all_EERs(
    ...
    for pred, key in zip(preds, keys):
        #? Pred: cosine sim of mbeded audio and enrolled mbeded
    ...
    fpr, tpr, sv_threshold = roc_curve(sv_labels, sv_preds, pos_label=1)
    ...
    # print(f" sv tpr {tpr}")
    # print(f" sv fpr {fpr}")
    # print(f" sv_threshold fpr {sv_threshold}")
    # print(f" spf tpr {tpr}")
    # print(f" spf fpr {fpr}")
    # print(f" spf_threshold fpr {spf_threshold}")
    # print(f" sasv tpr {tpr}")
    # print(f" sasv fpr {fpr}")
    # print(f" sasv_threshold fpr {sasv_threshold}")
